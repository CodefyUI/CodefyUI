...
from cdui_plugins.foundations.nodes.edu_logistic_regression_node import EduLogisticRegressionNode
...
def test_node_metadata():
    assert EduLogisticRegressionNode.NODE_NAME == "Edu-LogisticRegression"
