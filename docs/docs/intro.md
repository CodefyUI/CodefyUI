...
- **Build models visually** — drag-and-drop nodes, connect ports with type-safe edges, get real-time validation. **146 built-in nodes** across 16 categories (CNN, RNN, Transformer, RL, Data, Training, LLM, Diffusion, Classical ML, and more).
