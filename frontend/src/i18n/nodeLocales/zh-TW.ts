...
const zhTW: NodeTranslations = {
  ...
  EvaluateModel: {
    ...
    params: {
      ...
      device: '評估裝置',
      precision: '前向傳播用的混合精度。bf16 在 Ampere 以後的顯卡上可以把 activation 記憶體用量大約減半，其他都不用改；fp16 則是給更舊的顯卡用的。不論選哪一種，參數都維持 fp32，所以只影響記憶體/速度，不會影響量出來的準確率。裝置做不到的話會自動退回 fp32 並記錄下來。',
    },
  },
  BackwardOnce: {
