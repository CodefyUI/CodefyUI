...
> = {
  ...
  // The slot presets used to hold. A floppy disk because the panel lists the
  // graphs that have been SAVED -- the only icon in the set that says so.
  graphs: { Icon: SaveIcon, labelKey: 'sidebar.tab.graphs' },
